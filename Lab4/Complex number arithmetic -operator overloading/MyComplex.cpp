...
//Addition of two MyComplex numbers, change Add to new instance
...
//Subtraction of two MyComplex numbers, change subtraction to new instance
MyComplex MyComplex::operator-(const MyComplex &z){
    double r = real - z.real;
    double i = image - z.image;
    return MyComplex(r, i);
...
//Multiplication of two MyComplex numbers, change multiplication to new instance
MyComplex MyComplex::operator*(const MyComplex &z){
